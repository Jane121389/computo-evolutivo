public class ProgramaBeales_e
{
    public static void main(String[] args)
    {
        ...
        /*for(multiplo_longitud=8;multiplo_longitud<12;multiplo_longitud=multiplo_longitud+2)
            for(pc=0.6;pc<.8;pc=pc+.1)
            {
                ...
                for(individuos=longitud;entero<2;individuos=(longitud*entero))
                {
                    ...
                    for(int i=0;i<5;i++)
                    {
                        ...
                        AG_elitista<MinimizaBeales> ag01=new AG_elitista<MinimizaBeales>(modelo1,longitud,individuos,pc,pm);
